...
| LF-C-05 | „Ist das dein Set?“-Rückfrage + manuelle Eingabe     | `ScanResultScreen.test.tsx` (4 Fälle: bestätigt/unsicher/unbekannt/Pflichtfelder) | Ja                                      | —                                                                                                                                                                                                                                                                                             |
...
61 Tests, 13 Suiten, alle grün (`npm test`). CI läuft bei jedem PR
